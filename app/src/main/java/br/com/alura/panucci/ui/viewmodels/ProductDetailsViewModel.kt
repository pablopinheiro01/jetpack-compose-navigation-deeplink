...
class ProductDetailsViewModel(
    ...
    private var discount = BigDecimal.ZERO //init none discount because zero is equals none
    ...
    fun findProductById(id: String) {
        ...
        viewModelScope.launch {
            ...
            val dataState = dao.findById(id)?.let { product ->
                val priceWithDiscount = product.price - (product.price * discount)//add discount
    ...
    companion object{
        //add factory to produce new object with dependencies
